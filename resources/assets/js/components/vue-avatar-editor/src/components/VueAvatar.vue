<template>
<div>
   <canvas :width="canvasWidth" :height="canvasHeight" ref="canvas" @dragover.prevent @drop="onDrop" @mousedown="onDragStart" @mouseup="onDragEnd"
    @mousemove="onMouseMove" @click="clicked" v-bind:class="cursor"></canvas>
  ...
  if (borderRadius === 0) {
	...
	export default {
		props:{
			...
			color:{
				type:Array,
				default:function(){return [0, 0, 0, 1]}
			}
		},
		data:function(){
			return {
